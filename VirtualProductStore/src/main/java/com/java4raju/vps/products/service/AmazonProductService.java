...
import com.java4raju.vps.products.repositories.AmazonProductRepository;
...
public class AmazonProductService implements ProductService{
	...
	@PostConstruct
	void init() {
		log.info("Initialize Amazon data storage");
		pList.add(new ProductDTO(storeName, "TV","CurveTv", "LG", 10000));
		pList.add(new ProductDTO(storeName, "Frige", "Fridge", "Samsung", 20000));
		pList.add(new ProductDTO(storeName, "Mobile", "iPhone15", "Apple", 15000));
		pList.add(new ProductDTO(storeName, "Book", "QuantumPhysics","AB Publication", 450));
